 ...
 *
 * Derived from the Configure-generated config.h that ships in perl-4.036
 * (July 1992).  71 defines are switched off (each annotated in place with the
 * reason) and 5 are given new values: BIN, BYTEORDER, CPPSTDIN, PRIVLIB, SCRIPTDIR.
 ...
 */
#define BIN "."	/* no /usr/local on a bare-metal target */

/* BYTEORDER
 *	This symbol contains an encoding of the order of bytes in a long.
 *	Usual values (in hex) are 0x1234, 0x4321, 0x2143, 0x3412...
 */
#define BYTEORDER 0x1234	/* riscv64 is little-endian; the upstream config.h was generated on a big-endian host */
 ...
 */
#define CPPSTDIN "cpp"	/* only reached by perl -P, which cannot run here */
#define CPPMINUS ""
 ...
 */
/* #define HAS_BCMP -- disabled: prefer memcmp */
 ...
 *	roll your own.
 */
/* #define HAS_BCOPY -- disabled: prefer memcpy */
/* #define SAFE_BCOPY -- disabled: unused once HAS_BCOPY is off */
 ...
 *	or roll your own.
 */
/* #define HAS_BZERO -- disabled: prefer memset */
 ...
 */
/* #define HAS_CRYPT -- disabled: no libcrypt */

/* CSH
 *	This symbol, if defined, indicates that the C-shell exists.
 *	If defined, contains the full pathname of csh.
 */
/* #define CSH -- disabled: no shell to exec */
 ...
 */
/* #define HAS_DUP2 -- disabled: no dup2 wrapper */

/* HAS_FCHMOD
 *	This symbol, if defined, indicates that the fchmod routine is available
 *	to change mode of opened files.  If unavailable, use chmod().
 */
/* #define HAS_FCHMOD -- disabled: no permissions */

/* HAS_FCHOWN
 *	This symbol, if defined, indicates that the fchown routine is available
 *	to change ownership of opened files.  If unavailable, use chown().
 */
/* #define HAS_FCHOWN -- disabled: no permissions */

/* HAS_FCNTL
 *	This symbol, if defined, indicates to the C program that
 *	the fcntl() function exists.
 */
/* #define HAS_FCNTL -- disabled: no fcntl wrapper */
 ...
 */
/* #define HAS_FLOCK -- disabled: no locking */
 ...
 */
/* #define HAS_GETGROUPS -- disabled: no user database */
 ...
 */
/* #define HAS_GETPGRP -- disabled: no process groups */
 ...
 */
/* #define HAS_GETPRIORITY -- disabled: no scheduler */
 ...
 *	are available to do network order byte swapping.
 */
/* #define HAS_HTONS -- disabled: no network stack */
/* #define HAS_HTONL -- disabled: no network stack */
/* #define HAS_NTOHS -- disabled: no network stack */
/* #define HAS_NTOHL -- disabled: no network stack */
 ...
 */
/* #define HAS_KILLPG -- disabled: no process groups */

/* HAS_LSTAT
 *	This symbol, if defined, indicates that the lstat() routine is
 *	available to stat symbolic links.
 */
/* #define HAS_LSTAT -- disabled: no symlinks */
 ...
 */
/* #define HAS_READDIR -- disabled: no directory streams */
 ...
 *	trick.
 */
/* #define HAS_RENAME -- disabled: no rename wrapper in newlib */

/* HAS_REWINDDIR
 *	This symbol, if defined, indicates that the rewindir routine is
 *	available to rewind directories.
 */
/* #define HAS_REWINDDIR -- disabled: no directory streams */
 ...
 */
/* #define HAS_SETPRIORITY -- disabled: no scheduler */
 ...
 *	program.
 */
/* #define HAS_SETREGID -- disabled: no uids */
/*#undef	HAS_SETRESGID		/**/
 ...
 *	program.
 */
/* #define HAS_SETREUID -- disabled: no uids */
/*#undef	HAS_SETRESUID		/**/
 ...
 */
/* #define HAS_SETRGID -- disabled: no uids */

/* HAS_SETRUID
 *	This symbol, if defined, indicates that the setruid routine is available
 *	to change the real uid of the current program.
 */
/* #define HAS_SETRUID -- disabled: no uids */

/* HAS_SHM
 *	This symbol, if defined, indicates that the entire shm*(2) library is
 *	supported.
 */
/* #define HAS_SHM -- disabled: no SysV IPC */
 ...
 */
/* #define HAS_SHMAT -- disabled: no SysV IPC */
 ...
 */
/* #define HAS_SOCKET -- disabled: no network stack */

/* #define HAS_SOCKETPAIR -- disabled: no network stack */
 ...
 */
/* #define STDSTDIO -- disabled: reaches into FILE internals (_ptr/_cnt); newlib's differ */
 ...
 */
/* #define HAS_SYMLINK -- disabled: no symlinks */

/* HAS_SYSCALL
 *	This symbol, if defined, indicates that the syscall routine is available
 *	to call arbitrary system calls.  If undefined, that's tough.
 */
/* #define HAS_SYSCALL -- disabled: no syscall(2) */

/* HAS_TELLDIR
 *	This symbol, if defined, indicates that the telldir routine is
 *	available to tell your location in directories.
 */
/* #define HAS_TELLDIR -- disabled: no directory streams */

/* HAS_TRUNCATE
 *	This symbol, if defined, indicates that the truncate routine is
 *	available to truncate files.
 */
/* #define HAS_TRUNCATE -- disabled: no truncate wrapper in newlib */

/* HAS_VFORK
 *	This symbol, if defined, indicates that vfork() exists.
 */
/* #define HAS_VFORK -- disabled: no processes */
 ...
 */
/* #define HAS_WAIT4 -- disabled: no processes */

/* HAS_WAITPID
 *	This symbol, if defined, indicates that waitpid() exists.
 */
/* #define HAS_WAITPID -- disabled: no processes */
 ...
 *	include grp.h.
 */
/* #define I_GRP -- disabled: no user database */
 ...
 *	include sys/in.h.
 */
/* #define I_NETINET_IN -- disabled: no network stack */
/*#undef	I_SYS_IN		/**/
 ...
 *	contains pw_comment.
 */
/* #define I_PWD -- disabled: no user database */
/*#undef	PWQUOTA		/**/
#define	PWAGE		/**/
/*#undef	PWCHANGE	/**/
/*#undef	PWCLASS		/**/
 ...
 */
/* #define I_SYS_FILE -- disabled: no <sys/file.h> */

/* I_SYSIOCTL
 *	This symbol, if defined, indicates that sys/ioctl.h exists and should
 *	be included.
 */
/* #define I_SYSIOCTL -- disabled: no ioctl */
 ...
 *	include utime.h.
 */
/* #define I_UTIME -- disabled: no utime */

/* I_VARARGS
 *	This symbol, if defined, indicates to the C program that it should
 *	include varargs.h.
 */
/* #define I_VARARGS -- disabled: modern gcc refuses <varargs.h>; perl has a fixed-argument fallback for exactly this case */

/* I_VFORK
 *	This symbol, if defined, indicates to the C program that it should
 *	include vfork.h.
 */
/* #define I_VFORK -- disabled: no processes */
 ...
 */
/* #define I_DIRENT -- disabled: no directory streams */
/*#undef	I_SYS_DIR	/**/
/*#undef	I_NDIR		/**/
/*#undef	I_SYS_NDIR	/**/
/*#undef	I_MY_DIR	/**/
 ...
 */
/* #define MYMALLOC -- disabled: use newlib's allocator over the harness _sbrk */
 ...
 */
#define SCRIPTDIR "."	/* no /usr/local on a bare-metal target */
 ...
 */
#define PRIVLIB "."	/* library path: the frontend server's cwd */
