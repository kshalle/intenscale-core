...
object Instructions {
  ...
  def C_RESERVED         = BitPat("b???????????????10000000000000000")
  def C_RESERVED_OVLP    = BitPat("b????????????????0000000000000000")
  def C_ADDI4SPN         = BitPat("b???????????????0000???????????00")
  def C_ADDI4SPN_OVLP    = BitPat("b????????????????000???????????00")
  ...
  def C_ADDI16SP         = BitPat("b???????????????0011?00010?????01")
  def C_ADDI16SP_OVLP    = BitPat("b????????????????011?00010?????01")
  def C_ADDIW            = BitPat("b????????????????001???????????01")
  def C_ADDI             = BitPat("b????????????????000???????????01")
  def C_JAL              = BitPat("b????????????????001???????????01")
  def C_LI               = BitPat("b????????????????010???????????01")
  def C_LUI              = BitPat("b???????????????1011???????????01")
  def C_LUI_OVLP         = BitPat("b????????????????011???????????01")
  def C_J                = BitPat("b????????????????101???????????01")
  def C_BEQZ             = BitPat("b????????????????110???????????01")
  def C_BNEZ             = BitPat("b????????????????111???????????01")
  def C_EBREAK           = BitPat("b????????????????1001000000000010")
  def C_JR               = BitPat("b???????????????01000?????0000010")
  def C_JALR             = BitPat("b???????????????01001?????0000010")
  def C_SLLI_RV32        = BitPat("b????????????????0000??????????10")
  def C_MV               = BitPat("b???????????????11000??????????10")
  def C_ADD              = BitPat("b???????????????11001??????????10")
  def C_JR_OVLP          = BitPat("b????????????????1000?????0000010")
  def C_JALR_OVLP        = BitPat("b????????????????1001?????0000010")
  def C_MV_OVLP          = BitPat("b????????????????1000??????????10")
  def C_ADD_OVLP         = BitPat("b????????????????1001??????????10")
