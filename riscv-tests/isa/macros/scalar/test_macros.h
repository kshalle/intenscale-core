...
#define TEST_ST_OP( testnum, load_inst, store_inst, result, offset, base, addInc ) \
    TEST_CASE( testnum, x30, result, \
      la  x1, base; \
      add x1, x1, addInc; \
      li  x2, result; \
...
#define TEST_ST_SRC12_BYPASS( testnum, src1_nops, src2_nops, load_inst, store_inst, result, offset, base, addInc) \
test_ ## testnum: \
    li  TESTNUM, testnum; \
    li  x4, 0; \
1:  li  x1, result; \
...
#define TEST_ST_SRC21_BYPASS( testnum, src1_nops, src2_nops, load_inst, store_inst, result, offset, base, addInc) \
test_ ## testnum: \
    li  TESTNUM, testnum; \
    li  x4, 0; \
1:  la  x2, base; \
